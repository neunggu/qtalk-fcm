package com.quack.talk.fcm.service;
...
public class PushService {
    ...
    private void initialize() {
        try {
            ...
            FirebaseOptions options = FirebaseOptions.builder()
                    .setCredentials(GoogleCredentials.fromStream(new ClassPathResource("fcm/"+firebaseConfig).getInputStream())).build();
    ...
    public String sendPnsToDevice(NotificationRequestDto notificationRequestDto) {
        ...
        Message message = Message.builder()
                ...
                .setNotification(newNoti(notificationRequestDto.getTitle(), notificationRequestDto.getBody()))
    ...
    public String sendPnsToTopic(NotificationRequestDto notificationRequestDto) {
        Message message = Message.builder()
                ...
                .putData("sender", notificationRequestDto.getSender())
                .putData("body", notificationRequestDto.getBody())
                .build();
    ...
    private Notification newNoti(String title, String body){
        return Notification
                .builder()
                .setTitle(title)
                .setBody(body)
